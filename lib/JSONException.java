...
<meta content="zfxDVJD2DgjqJjyuyesy+MXzuvoesWB/uvpS6uSCQ4c=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-3dfade455751c308f4b207b1a29a6cb39093d144.css" media="screen" rel="stylesheet" type="text/css" />
      ...
      <script src="https://a248.e.akamai.net/assets.github.com/assets/github-b608aa76186980c18854c64369b5cebbb3d253b1.js" type="text/javascript"></script>
        ...
        <link rel='permalink' href='/douglascrockford/JSON-java/blob/50c3afb2166798c5de0896b90659d8a2b2f8fcec/JSONException.java'>
      ...
      <div class="select-menu-modal-holder js-menu-content js-navigation-container js-select-menu-pane">
        ...
        <div class="select-menu-modal js-select-menu-pane">
          ...
          <div class="select-menu-list js-filter-tab js-filter-branches css-truncate" data-filterable-for="commitish-filter-field" data-filterable-type="substring">
              ...
              <div class="select-menu-item js-navigation-item js-navigation-target selected">
                <span class="select-menu-checkmark mini-icon mini-icon-confirm"></span>
                <a href="/douglascrockford/JSON-java/blob/master/JSONException.java" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
              </div> <!-- /.select-menu-item -->
...
<!-- blob contrib key: blob_contributors:v21:3ef1a1b4e2c06e235a1d8499489addc5 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:3ef1a1b4e2c06e235a1d8499489addc5 -->
...
<div id="slider">
  ...
  <div class="commit file-history-tease">
    <img class="main-avatar" height="24" src="https://secure.gravatar.com/avatar/52f27e9297ec2a53d579ccfb5b7e99ff?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="24" />
    <span class="author"><a href="/ajayk" rel="author">ajayk</a></span>
    <time class="js-relative-date" datetime="2012-01-12T23:40:10-08:00" title="2012-01-12 23:40:10">January 12, 2012</time>
    <div class="commit-title">
        <a href="/douglascrockford/JSON-java/commit/9420bb7e8bbaf36d3d364cb7bb11449e8c3bbeed" class="message">AjayKemparaj: Tabs to spaces and minor java code fixups</a>
    </div>

    <div class="participation">
      <p class="quickstat"><a href="#blob_contributors_box" rel="facebox"><strong>2</strong> contributors</a></p>
          <a class="avatar tooltipped downwards" title="douglascrockford" href="/douglascrockford/JSON-java/commits/master/JSONException.java?author=douglascrockford"><img height="20" src="https://secure.gravatar.com/avatar/b871de839c31ddb1d9db8e33e0cb88a6?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="20" /></a>
    <a class="avatar tooltipped downwards" title="ajayk" href="/douglascrockford/JSON-java/commits/master/JSONException.java?author=ajayk"><img height="20" src="https://secure.gravatar.com/avatar/52f27e9297ec2a53d579ccfb5b7e99ff?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="20" /></a>
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/douglascrockford/JSON-java/blob/50c3afb2166798c5de0896b90659d8a2b2f8fcec/JSONException.java" data-title="JSON-java/JSONException.java at master · douglascrockford/JSON-java · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/douglascrockford/JSON-java/raw/master/JSONException.java" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/douglascrockford/JSON-java/blame/master/JSONException.java" class="button minibutton ">Blame</a>
                  <a href="/douglascrockford/JSON-java/commits/master/JSONException.java" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L28" rel="#L28">28</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="kn">package</span> <span class="n">org</span><span class="o">.</span><span class="na">json</span><span class="o">;</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="cm">/**</span></div><div class='line' id='LC4'><span class="cm"> * The JSONException is thrown by the JSON.org classes when things are amiss.</span></div><div class='line' id='LC5'><span class="cm"> * @author JSON.org</span></div><div class='line' id='LC6'><span class="cm"> * @version 2010-12-24</span></div><div class='line' id='LC7'><span class="cm"> */</span></div><div class='line' id='LC8'><span class="kd">public</span> <span class="kd">class</span> <span class="nc">JSONException</span> <span class="kd">extends</span> <span class="n">Exception</span> <span class="o">{</span></div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="mi">0</span><span class="o">;</span></div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">private</span> <span class="n">Throwable</span> <span class="n">cause</span><span class="o">;</span></div><div class='line' id='LC11'><br/></div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="cm">/**</span></div><div class='line' id='LC13'><span class="cm">     * Constructs a JSONException with an explanatory message.</span></div><div class='line' id='LC14'><span class="cm">     * @param message Detail about the reason for the exception.</span></div><div class='line' id='LC15'><span class="cm">     */</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">public</span> <span class="nf">JSONException</span><span class="o">(</span><span class="n">String</span> <span class="n">message</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">super</span><span class="o">(</span><span class="n">message</span><span class="o">);</span></div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">}</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">public</span> <span class="nf">JSONException</span><span class="o">(</span><span class="n">Throwable</span> <span class="n">cause</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC21'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">super</span><span class="o">(</span><span class="n">cause</span><span class="o">.</span><span class="na">getMessage</span><span class="o">());</span></div><div class='line' id='LC22'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">this</span><span class="o">.</span><span class="na">cause</span> <span class="o">=</span> <span class="n">cause</span><span class="o">;</span></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">}</span></div><div class='line' id='LC24'><br/></div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">public</span> <span class="n">Throwable</span> <span class="nf">getCause</span><span class="o">()</span> <span class="o">{</span></div><div class='line' id='LC26'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="k">this</span><span class="o">.</span><span class="na">cause</span><span class="o">;</span></div><div class='line' id='LC27'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">}</span></div><div class='line' id='LC28'><span class="o">}</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.06092s from fe14.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
<div id="keyboard_shortcuts_pane" class="instapaper_ignore readability-extra" style="display:none">
  ...
  <div class="js-hidden-pane" style='display:none'>
    ...
    <span id='server_response_time' data-time='0.06219' data-host='fe14'></span>
